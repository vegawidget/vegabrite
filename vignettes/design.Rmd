...
At the moment, the various top-level specs are S3 classes.  A few of the internal functions take advantage of the classes to help determine the right way to add a component.
