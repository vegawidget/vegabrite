...
For a more thorough introduction to how to use the package, see [introduction vignette](https://vegawidget.github.io/vlbuildr/articles/articles/introduction.html). For example charts see the [example gallery](https://vegawidget.github.io/vlbuildr/articles/articles/example_gallery.html).
