...
This vignette covers the basics of how to make a chart using `vlbuildr`.For more about the design philosophy of the package, see the [design vignette](https://vegawidget.github.io/vlbuildr/articles/design.html). For example charts see the [examples vignette](https://vegawidget.github.io/vlbuildr/articles/articles/examples.html).  For much more information about what is possible with Vega-Lite, see the [Vega-Lite documentation](https://vega.github.io/vega-lite/docs/).  
