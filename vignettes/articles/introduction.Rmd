...
This vignette has covered the basics of building a plot with `vlbuildr` but the really power of the package and `vega-lite` is the ability to compose multiple views and add interactivity!  For those topics, see the dedicated vignettes on [Composition](https://vegawidget.github.io/vlbuildr/articles/articles/composition.html) and [Interactivity](https://vegawidget.github.io/vlbuildr/articles/articles/interactivity.html).*

For customizing the appearance of charts, see the vignetted on [customization](https://vegawidget.github.io/vlbuildr/articles/articles/customization.html).