---
title: "How to make a plot using vlr"
...
This vignette covers the basics of how to make a chart using `vlr`.For more about the design philosophy of the package, see the [design vignette](https://vegawidget.github.io/vlr/articles/design.html). For example charts see the [examples vignette](https://vegawidget.github.io/vlr/articles/articles/example_gallery.html).  For much more information about what is possible with Vega-Lite, see the [Vega-Lite documentation](https://vega.github.io/vega-lite/docs/).  
...
`vlr` also has a shortcut, whereby if you pass "data" or "encoding" to the tooltip argument, it will transform it into the above list format in the spec. So the following will do the same thing:
