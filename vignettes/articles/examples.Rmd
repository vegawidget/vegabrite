...
vl_chart() %>%
  ...
  vl_add_selection_parameter("CylYr", select = c(type = "point", fields = list(list("Cylinders","Year")))) %>%
...
vl_chart() %>%
  ...
  vl_add_selection_parameter("brush", select = list(type = "interval", resolve = "global")) %>%
  vl_encode_color(value = "grey") %>%
