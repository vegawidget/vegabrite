...
### Error bars and bands {.tabset}

### Box plots {.tabset}

### Layered Plots {.tabset}
...
vl_chart() %>%
  ...
  # Alternatively could use (will change how facet added to underlying spec):
  # vl_encode_row('Origin:N') 
...
vl_chart() %>%
  ...
  vl_encode_facet("site:O", columns = 2, sort = list(op = 'median', field = 'yield')) 
  # Alternatively could use (will change how facet added to underlying spec):
  #vl_facet("site:O", columns = 2, sort = list(op = 'median', field = 'yield')) 
