...
These are some examples showing current capabilities (note, might not actually show up here on github due to current issues rendering to markdown format, see pkgdown site for these and more examples.)
